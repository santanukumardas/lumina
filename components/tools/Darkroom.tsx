    ...
    return (
        <div className="max-w-7xl mx-auto p-4 animate-slide-up">
             <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-white mb-2 font-serif tracking-tight">The Darkroom</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                ...
                <div className="space-y-2">
                    ...
                    <div className="aspect-[4/3] max-h-[40vh] w-auto mx-auto rounded-xl overflow-hidden border border-zinc-700 relative isolate shadow-2xl" style={{ WebkitMaskImage: '-webkit-radial-gradient(white, black)' }}>
                        <img 
                            src={sourceImage}
                        ...
                        />
                         {score !== null && (
                            <div className="absolute inset-0 bg-black/60 backdrop-blur-sm flex flex-col items-center justify-center animate-fade-in">
                                <span className="text-5xl font-bold text-white mb-2 font-mono">{score}%</span>
                                <span className="text-zinc-300 text-sm font-serif italic">Match Accuracy</span>
                            </div>
                        )}
                    </div>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <div className="aspect-[4/3] max-h-[40vh] w-auto mx-auto rounded-xl overflow-hidden border border-zinc-700 isolate shadow-2xl" style={{ WebkitMaskImage: '-webkit-radial-gradient(white, black)' }}>
                        <img 
                            src={sourceImage}
                            className="w-full h-full object-cover"
                            style={{ 
            ...
            <div className="bg-zinc-900/60 backdrop-blur-md border border-white/5 rounded-2xl p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                     <div className="space-y-2">
                        <div className="flex justify-between text-sm text-zinc-400 uppercase tracking-wider text-xs font-bold">
                            <span>Exposure</span>
                        ...
                        <input 
                            ...
                            className="w-full accent-white cursor-pointer h-1.5 bg-zinc-700 rounded-lg appearance-none" 
                        />
                     </div>
                     <div className="space-y-2">
                        <div className="flex justify-between text-sm text-zinc-400 uppercase tracking-wider text-xs font-bold">
                            <span>Contrast</span>
                            <span className="font-mono text-white">{contrast.toFixed(2)}</span>
                        </div>
                        <input 
                     ...
                     <div className="space-y-2">
                        <div className="flex justify-between text-sm text-zinc-400 uppercase tracking-wider text-xs font-bold">
                            ...
                            <span className="font-mono text-white">{saturation.toFixed(2)}</span>
                        </div>
                        <input 
                ...
                <div className="mt-8 flex flex-col items-center">
                    <button onClick={calculateScore} className="px-8 py-3 bg-white text-black font-bold rounded-full hover:bg-zinc-200 transition-colors shadow-lg">
                        Grade Photo
                    </button>
